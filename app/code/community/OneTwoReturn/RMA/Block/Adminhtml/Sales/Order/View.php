...
class OneTwoReturn_RMA_Block_Adminhtml_Sales_Order_View extends Mage_Adminhtml_Block_Sales_Order_View
{
            ...
            {                
                if($allowedOrder['selective_rma']!='true')
                {
                    ...
                    $this->_addButton('order_allow_rma', array(
                        ...
                        'onclick'   => "confirmSetLocation('{$message}', '". Mage::helper("adminhtml")->getUrl('12return/adminhtml_rma/allow/',$params2) ."')", 
                    ), 0, 11);
                } 
                else 
                {
                    ...
                    $this->_addButton('order_disallow_rma', array(
                        ...
                        'onclick'   => "confirmSetLocation('{$message}', '". Mage::helper("adminhtml")->getUrl('12return/adminhtml_rma/disallow/',$params2) ."')",
                    ), 0, 11);
                }
            ...
            if (Mage::app()->getWebsite($websiteId)->getConfig('rma/warranty/selectiverma')=='perorder' &&  Mage::app()->getWebsite($websiteId)->getConfig('rma/warranty/enabled'))
            {
                if($allowedOrder['selective_rma_warranty']!='true')
                {
                    ...
                    $this->_addButton('order_allow_rma_warranty', array(
                        ...
                        'onclick'   => "confirmSetLocation('{$message}', '". Mage::helper("adminhtml")->getUrl('12return/adminhtml_rma/allowwarranty/',$params2) ."')", 
                    ), 0, 12);  
                }
                else
                {
                    ...
                    $this->_addButton('order_disallow_rma_warranty', array(
                        ...
                        'onclick'   => "confirmSetLocation('{$message}', '". Mage::helper("adminhtml")->getUrl('12return/adminhtml_rma/disallowwarranty/',$params2) ."')",
                    ), 0, 12);                       
                }
            }
