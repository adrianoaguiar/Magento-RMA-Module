<?php
class OneTwoReturn_RMA_Block_Adminhtml_Sales_Order_View_Tab_Rma
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
	...
	protected function _prepareCollection()
    {
      ...
      $collection = Mage::getModel('rma/rma')->getCollection()->addFieldToFilter('rma_order_entity_id', $this->getOrder()->getEntityId());
